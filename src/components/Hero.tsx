  ...
  return (
    <div className="p-5 mt-40 lg:mt-52 flex flex-col items-center justify-center">
      ...
      <div className="rounded-2xl ">
        <p className="bg-muted p-1.5 pl-0 rounded-2xl text-xs lg:text-sm ">
          <span className="bg-primary text-secondary px-3 py-2 rounded-2xl m-0">
            New
          </span>{" "}
      ...
      <div className="p-5 lg:px-100">
        ...
        <div className="mt-8 text-center">
          <p className="text-xl text-muted-foreground">
            Poweful, flexible and data-driven, Attio makes it easy to build the
        ...
        <div className="mt-15 lg:mt-36">
          <img
            src="https://ik.imagekit.io/wq68aygdr/attio/hero.png"
            alt="hero"
          />
        </div>
      </div>
